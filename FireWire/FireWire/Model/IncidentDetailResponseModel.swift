...
struct IncidentDetailResponseModel: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case id = "_id"
        case locality, subLocality, latitude, longitude, address, respondingUnits, featured, sendPushNotification, postFacebook, postTwitter, field1Value, field2Value, field3Value, field4Value, field5Value
        case v = "__v"
    }
}
