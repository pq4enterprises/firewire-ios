...
// MARK: - Design tokens (incident redesign)
...
enum IncidentTheme {
    ...
    static let redTint = UIColor(
        ...
        dark: IncidentTheme.red.withAlphaComponent(0.20))
...
enum UnitCategory: CaseIterable {
    ...
    var chipBackground: UIColor {
        switch self {
        case .engine: return UIColor(rgb: 0x1C1C1E)
        case .truckRescue: return IncidentTheme.red
        case .marine: return UIColor(rgb: 0x17B26A)
        case .chief: return UIColor(rgb: 0xF7C948)
        case .soc:
            return UIColor(light: UIColor(rgb: 0xFCF0E4), dark: UIColor(rgb: 0xE0842F).withAlphaComponent(0.20))
        case .other:
            return IncidentTheme.surface2
        }
    }

    var chipText: UIColor {
        switch self {
        case .engine: return .white
        case .truckRescue, .marine, .chief: return .black
        case .soc: return UIColor(light: 0xB5661F, dark: 0xF2B47C)
        case .other: return IncidentTheme.muted
        }
    }
    ...
    var legendColor: UIColor {
        ...
        case .marine: return UIColor(rgb: 0x17B26A)
        case .chief: return UIColor(rgb: 0xF7C948)
        case .soc: return UIColor(rgb: 0xE0842F)
        case .other: return IncidentTheme.muted
        }
    }
