...
enum APIEndpoints {
//    #if DEV
//        static var baseURL = "https://dev-firewire-api.atomgroups.work/"
//    #else
...
//    #endif
    ...
    static let postAdminUrl = "https://dev-firewire.atomgroups.work/noauth/create/incident?form=add&token=%@&theme=%@"
}
