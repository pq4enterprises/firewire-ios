...
enum FWImageResources: String {
    ...
    case menuIconRed = "menu_red_icon"
    ...
    case mapFireMarker = "map_fire_marker"
...
struct FWImage {
    ...
    static let menuIconRed = UIImage.appImage(.menuIconRed)
    ...
    static let mapFireMarker = UIImage.appImage(.mapFireMarker)
